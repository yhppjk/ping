...
/* void ADC_init(void)                                                               */
/*...................................................................................*/
/* Description : Initialize the parameters of ADC                                    */
/* Inputs :                                                                          */
/*      - void                                                                       */
/* Output :                                                                          */
/*      - void                                                                       */
...
/*...................................................................................*/
/* void ADC_init_ADC_init_opacite(void)                                              */
/*...................................................................................*/
/* Description : Initialize the parameters of ADC for opacity                        */
/* Inputs :                                                                          */
/*      - void                                                                       */
/* Output :                                                                          */
/*      - void                                                                       */
...
/* Description : Initialize the parameters of ADC                                    */
/* Inputs :                                                                          */
/*      - unsigned char voie : select the pin as the channel of ADC to mesure        */
/* Output :                                                                          */
/*      - void                                                                       */
/*...................................................................................*/
void ADC_Demarrer_conversion(unsigned char voie);
...
/*...................................................................................*/
/* Description : Get the value of ADC mesurement                                     */
/* Inputs :                                                                          */
/*      - void                                                                       */
/* Output :                                                                          */
/*      - int: the value of ADC from 0 to 1023                                       */
/*...................................................................................*/
int ADC_Lire_resultat ();
...
/*...................................................................................*/
/* Description : Send a string from the beginning of the table                       */
/* Inputs :                                                                          */
/*      - unsigned char *ptr : an address as the beginning of table                  */
/* Output :                                                                          */
/*      - void                                                                       */
/*...................................................................................*/
void send_string(unsigned char *ptr);
...
/*...................................................................................*/
/* Description : Another fonction to send a string with 0x00                         */
/* Inputs :                                                                          */
/*      - unsigned char *ptr : an address as the beginning of table                  */
/* Output :                                                                          */
/*      - void                                                                       */
...
/*...................................................................................*/
/* Description : Send a char via UART                                                */
/* Inputs :                                                                          */
/*      - unsigned char sendchar : a char to send                                    */
/* Output :                                                                          */
/*      - void                                                                       */
/*...................................................................................*/
void send_char(unsigned char sendchar);
...
/* void Init_uart(void)                                                              */
/*...................................................................................*/
/* Description : Initialize the protocol UART                                        */
/* Inputs :                                                                          */
/*      - void                                                                       */
/* Output :                                                                          */
/*      - void                                                                       */
...
/* int getpm25(void)                                                                 */
/*...................................................................................*/
/* Description : Get the value received from the Sensor Particule                    */
/* Inputs :                                                                          */
/*      - void                                                                       */
/*                                                                                   */
/* Output :                                                                          */
/*      - int : the value PM2.5 in ug/m3                                             */
/*...................................................................................*/
int getpm25(void);
...
/*...................................................................................*/
/* Description : to convert the int value to char value for sending                  */
/*               each int need 2 char for save (the value has 2 bytes)               */
/* Inputs :                                                                          */
/*      - int input :  the value int                                                 */
/*      - int i :  the place to move for save in a char                              */
/*                                                                                   */
/* Output :                                                                          */
/*      - char : the char value                                                      */
/*...................................................................................*/
...
int main(void)
{
    ...
    /* The sensor need some times to start up */
       while(count<400){
    ...
    while(1)
    {
      ...
      if((P2IN&BIT0) && !(P2IN&BIT1) ){     // Seuil opacite > 300 diff_temperature > 2  particule > 2000
        ...
        else if ((flag_opacite>3) && (pm25 > 2000) ){
            state = 1;
        }
      ...
      if(!(P2IN&BIT0) && (P2IN&BIT1)){ //  Seuil opacite > 600   diff_temperature >  4  particule > 4000
          ...
          else if ((flag_opacite>6) && (pm25 > 4000) ){
              state = 1;
          }
      ...
      if((P2IN&BIT0) &&(P2IN&BIT1)){ //  Seuil opacite > 900    diff_temperature > 6  particule > 6000
          ...
          else if ((flag_opacite>10) && (pm25 > 6000) ){
              state = 1;
          }
      ...
      ADC_init();                   //Initialize the ADC for measurement temperature (with a reference voltage 2.5V)
      ADC_Demarrer_conversion(4); // channel Température
      ...
      count++;
        //      The actual temperature should be converted with equation.
        //      temperature = 1180-temperature;
        //      temperature=(560-temperature)/10;


      ADC_init_opacite();                   //Initialize the ADC for measurement opacity (with a reference voltage 1.5V)
      ADC_Demarrer_conversion(6);           // channel Opacité
      opacite_num = ADC_Lire_resultat();    //Get the value of ADC
      opacite = opacite_num * 1.5 /1023 *1000;  //Calculate with the 1024 steps of ADC10, the result is mV


      /* boucle pour calculer opacite */
      /* To know the a sum of detected times for opacity */
...
// Choix du diviseur par 1 pour l'horloge, d'arrage conversion logiciel
...
int ADC_Lire_resultat ()
{
    while (ADC10CTL1 & ADC10BUSY);  // Tant que ADC occupe on attend
